<%@ Page Title="Staff Sign Up" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StaffSignUp.aspx.cs" Inherits="Hotel_Management_System.Staff.StaffSignUp" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <h2 style="font-weight:bold">Staff Sign Up</h2>
                                    </center>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="contactNumber" runat="server" placeholder="e.g. 010-999-9999" TextMode="Phone"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox class="form-control" ID="zipTextBox" runat="server" placeholder="101010" TextMode="Number"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <div class="form-group">
                                        <asp:Button class="btn btn-success col-12 btn-lg" ID="signUpButton" runat="server" Text="Sign Up" OnClick="signUpButton_Click" />
                                    </div>
                                </div>
                            </div>
