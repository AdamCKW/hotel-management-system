<%@ Page Title="Product Management" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Products Management.aspx.cs" Inherits="Hotel_Management_System.Admin.Products_Management" %>
                 ...
                 <%--File Upload--%>
                  ...
                  <div class="row mb-3">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" style="border-color:black" ID="itemIDTextBox" runat="server" TextMode="Number"></asp:TextBox>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="itemNameTextBox" runat="server"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row mb-3">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" style="border-color:black" ID="foodTypeDropDownList" runat="server">
                  ...
                  <div class="row mb-3">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="itemDetailTextBox" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
                        </div>
                     </div>
                  </div>
