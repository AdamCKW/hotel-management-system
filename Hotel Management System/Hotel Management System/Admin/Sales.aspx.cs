    ...
    public partial class Sales : System.Web.UI.Page
    {
        ...
        void displaySortGridView()
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "SELECT * FROM order_tbl WHERE OrderStatusID=2 AND OrderDate BETWEEN '"+fdateTextBox.Text+"' AND '" + ldateTextBox.Text + "'";
                cmd.Connection = con;
        ...
        void displayGridView()
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "SELECT * FROM order_tbl WHERE OrderStatusID='2'";
                cmd.Connection = con;
                DataTable dt = new DataTable();
                using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                {
        ...
        private void ExportGridToExcel()
        {
            ...
            Response.Charset = "";
            string FileName = "Hotel Sales" + DateTime.Now + ".xls";
