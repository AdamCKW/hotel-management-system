<%@ Page Title="Room Management" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Hotel Room Management.aspx.cs" Inherits="Hotel_Management_System.Admin.Hotel_Room_Management" %>
            ...
            <div class="card">
               <div class="card-body" style="font-size:20px; font-family:Arial; font-weight:bold;">
                 ...
                 <%--File Upload--%>
                  <div class="row mb-3">
                     <div class="col">
                        <asp:FileUpload class="form-control" onchange="readURL(this)" style="border-color:black" ID="FileUpload1" runat="server" />
                     </div>
                  </div>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                                <asp:TextBox CssClass="form-control" style="border-color:black" ID="roomNoTextBox" placeholder="e.g. 100" runat="server"></asp:TextBox>
                                <asp:LinkButton class="btn btn-light" style="border-color:black"  ID="roomIDLinkButton" runat="server" OnClick="roomIDLinkButton_Click"><i class="fas fa-search"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <asp:LinkButton class="btn btn-success" style="border-color:black" ID="trueLinkButton" runat="server" OnClick="trueLinkButton_Click"><i class="fas fa-check-circle"></i></asp:LinkButton>
                                <asp:LinkButton class="btn btn-danger" style="border-color:black" ID="falseLinkButton" runat="server" OnClick="falseLinkButton_Click"><i class="fas fa-times-circle"></i></asp:LinkButton>
                            </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row mb-3">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                                  <asp:DropDownList class="form-control" style="border-color:black" ID="roomTypeList" runat="server">
                               ...
                               <asp:LinkButton class="btn btn-light" style="border-color:black" ID="getRoomDataButton" runat="server" OnClick="getRoomDataButton_Click"><i class="fas fa-search"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>Price</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="priceTextBox" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                  ...
                  <div class="row mb-4">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="adultTextBox" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="childrenTextBox" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                  ...
                  <div class="row mb-3">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" style="border-color:black" ID="descriptionTextBox" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="RoomID" DataSourceID="SqlDataSource1">
                            <Columns>
                                <asp:BoundField DataField="RoomID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="RoomID" />
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <div class="container-fluid">
