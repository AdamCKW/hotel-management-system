...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
      <div class="row justify-content-center">
         ...
         <div class="col-md-10 mx-auto" style="font-size:20px; font-family:Arial; font-weight:bold">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                         <center>
                             ...
                             <asp:LinkButton style="font-size:30px; font-weight:bold" class="roomlinks" ID="cleaningButton" runat="server" OnClick="cleaningButton_Click">Housekeeping</asp:LinkButton>
                         </center>
                     </div>
                     ...
                     <div class="col-md-6">
                         <center>
                             ...
                             <asp:LinkButton style="font-size:30px; font-weight:bold"  class="roomlinks" ID="foodButton" runat="server" OnClick="foodButton_Click">Food &amp; Drinks Service</asp:LinkButton>
                         </center>
                     </div>
