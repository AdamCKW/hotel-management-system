                     ...
                     <div class="col">
                        ...
                        <div class="row mb-3">
                             ...
                             <div class="col-md-6">
                                 ...
                                 <input id="adultCapacity" runat="server" class="form-control" onkeypress="return isNumberKey(event)" type="text" name="adultCapacity">
                             </div>

                             <%--No of children--%>
                             <div class="col-md-6">
                                 <label>No of Children</label>
                                 <input id="childrenCapacity" runat="server" class="form-control" onkeypress="return isNumberKey(event)" type="text" name="childrenCapacity">
                             </div>
                         </div>
