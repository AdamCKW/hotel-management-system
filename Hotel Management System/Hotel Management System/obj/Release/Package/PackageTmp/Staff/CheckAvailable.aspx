<%@ Page Title="Check Room Availability" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CheckAvailable.aspx.cs" Inherits="Hotel_Management_System.Staff.CheckAvailable" %>
                    ...
                    <div class ="col-md-10 mx-auto">
                        <div class="card" style="font-family:Arial">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" DataKeyNames="RoomNumber" AutoGenerateColumns="False" emptydatatext="Sorry! No Rooms Available.">
                                            <Columns>
