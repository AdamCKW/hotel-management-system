<%@ Page Title="Suite Room" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Suite Room.aspx.cs" Inherits="Hotel_Management_System.Room_Details.Suite_Room" %>
          ...
          <div class="col-md-10 mx-auto">
              <nav aria-label="breadcrumb" style="font-family: Arial">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Suite Room</li>
                  </ol>
               </nav>
          </div>
