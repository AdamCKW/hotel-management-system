<%@ Page Title="Deluxe Twin Room" Async="true" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Deluxe Twin Room.aspx.cs" Inherits="Hotel_Management_System.Room_Details.Deluxe_Twin_Room" %>
          ...
          <div class="col-md-10 mx-auto">
              <nav aria-label="breadcrumb" style="font-family: Arial">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Deluxe Twin Room</li>
                  </ol>
               </nav>
          </div>
