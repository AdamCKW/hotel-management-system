         ...
         <div class="col-md-10 mx-auto">
             <nav aria-label="breadcrumb" >
                 <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">F & D Service</li>
                 </ol>
             </nav>
         </div>
         <div class="col-md-10 mx-auto">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <h1 style="font-weight:bold">Food & Drinks Service</h1>
                        </center>
                     </div>
                  </div>
                  ...
                  <div class="row" style="font-size:20px; font-weight:bold">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="carouselFoodsInterval" class="carousel slide" data-bs-ride="carousel">
                                      ...
                                      <a href="/Public/HotelServices/FoodList.aspx">
                                    ...
                                    <center>
                                        <asp:LinkButton class="roomlinks" style="font-size:30px" ID="foodButton" runat="server" OnClick="foodButton_Click">Food</asp:LinkButton>
                                    </center>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="carouselDrinksInterval" class="carousel slide" data-bs-ride="carousel">
                                      ...
                                      <a href="/Public/HotelServices/DrinkList.aspx">
                                      <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="4000">
