<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DynamicPage.aspx.cs" Inherits="Hotel_Management_System.DynamicPage" %>
          ...
          <div class="col-md-10 mx-auto">
              <nav aria-label="breadcrumb" style="font-family: Arial">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/Public/HotelServices/Food.aspx">Foods</a></li>
                    <li class="breadcrumb-item active" aria-current="page" id="breadcrumb" runat="server"></li>
                  </ol>
               </nav>
          </div>

         <div class="col-md-10 mx-auto">
            <div class="card" style="font-size:20px; font-family:Arial;">
               <div class="card-body">
