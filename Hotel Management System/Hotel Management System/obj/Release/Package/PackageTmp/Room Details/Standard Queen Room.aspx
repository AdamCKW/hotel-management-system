<%@ Page Title="Standard Queen Room" Async="true" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Standard Queen Room.aspx.cs" Inherits="Hotel_Management_System.Room_Details.Standard_Queen_Room" %>
                     ...
                     <div class="col">
                         ...
                         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                             <ContentTemplate>
                                 ...
                                 <asp:ImageButton src="/imgs/speaker.png"  ID="audioImageButton" runat="server" OnClick="audioImageButton_Click"/>
