<%@ Page Title="Booking" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Search Room.aspx.cs" Inherits="Hotel_Management_System.Staff.Search_Room" %>
                    ...
                    <div class ="col-md-10 mx-auto">
                        <div class="card" style="font-family:Arial">
                            <div class="card-body">
                                <div class="row" >
                                   <div class="col">
                                       <h2 style="font-weight:bold">Available Rooms</h2>
                                   </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <asp:GridView class="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" emptydatatext="Sorry! There Are No Rooms Available." OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
                                            <Columns>
                                                ...
                                                <div class="col-lg-9">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("Available") %>' Font-Bold="True"></asp:Label>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <asp:LinkButton ID="btnreserve" class="btn btn-primary btn-sm" runat="server"
                                                              CommandName="reserve"
