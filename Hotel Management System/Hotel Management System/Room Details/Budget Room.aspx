<%@ Page Title="Budget Room" Async="true" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Budget Room.aspx.cs" Inherits="Hotel_Management_System.Room_Details.Budget_Room" %>
          ...
          <div class="col-md-10 mx-auto">
              <nav aria-label="breadcrumb" style="font-family: Arial">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Budget Room</li>
                  </ol>
               </nav>
          </div>
