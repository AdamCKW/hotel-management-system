<%@ Page Title="Staff Management" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Staff Management.aspx.cs" Inherits="Hotel_Management_System.Admin.Staff_Management" %>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" ID="getButton" runat="server" OnClick="getButton_Click"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
